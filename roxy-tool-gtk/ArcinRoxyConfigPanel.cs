...
namespace roxy_tool
{
    public class ArcinRoxyConfigPanel : IConfigPanel
    {
        ...
        public ArcinRoxyConfigPanel()
        {
            ...
            ComboBox rgbInterfaceCombo = new ComboBox(new string[] { "Disabled", "WS2812B (B9)" });
            ...
            //ComboBox rgbModeCombo = new ComboBox(new string[] { "Reactive Fallback" });
            ...
            OptionsGrid.Attach(new Label("Debounce Time:"), 0, 6, 1, 1);
            OptionsGrid.Attach(debounceBox, 1, 6, 1, 1);
            ...
            OptionsGrid.Attach(new Label("ASC Emulation:"), 0, 7, 1, 1);
        ...
        public byte[] GetConfigBytes()
        {
            ...
            // configBytes[24] = (byte)(widgetDict[OptionStrings.RgbBrightness] as SpinButton).Value; // Not used
