...
namespace roxy_tool
{
    public class RoxyConfigPanel : IConfigPanel
    {
        ...
        public byte[] GetConfigBytes()
        {
            ...
            configBytes[2] = 0x17;  // Roxy is 23 bytes
        ...
        public void PopulateControls(byte[] configBytes)
        {
            ...
            byte brightness = configBytes[24];
            byte debounce = configBytes[25];
            byte ascEmu = configBytes[26];
            ...
            (widgetDict[OptionStrings.RgbBrightness] as SpinButton).Value = brightness;
            (widgetDict[OptionStrings.DebounceTime] as SpinButton).Value = debounce;
            (widgetDict[OptionStrings.AscEmulation] as ComboBox).Active = ascEmu;
        }
